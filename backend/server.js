...
app.get("/", (req, res) => {
    res.send("TravelStories Backend is Working");
});
...
app.post("/api/stories", async (req, res) => {
    try {
        ...
        await db
            ...
            .input("StartPlace", sql.NVarChar(200), String(start).trim())
            .input("Destination", sql.NVarChar(200), String(destination).trim())
            .input("Transport", sql.NVarChar(200), String(transport).trim())
            .input("Cost", sql.Decimal(10, 2), numericCost)
            .input("Route", sql.NVarChar(sql.MAX), String(route).trim())
            .input("Experience", sql.NVarChar(sql.MAX), String(experience).trim())
            .input(
                "Tips",
...
async function startServer() {
    try {
        ...
        console.error("Check your SQL Server configuration.");
        console.error("");
